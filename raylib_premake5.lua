...
--  Modified from Jeffery Myers original version by Nicolas Urbanek 2024
...
project "raylib"
    ...
    location ("SpectralEngine/vendor/raylib-master")
    targetdir "SpectralEngine/bin/%{cfg.platform}_%{cfg.buildcfg}/%{prj.name}"
